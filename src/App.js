  ...
  return (
    <div className="App">
      ...
      <div className="text-center">
        <h1>
          {getNetwork !== 80001
            ? "Please make sure you're on the Contract Deployed testnet network"
            : mmStatus}
        </h1>
      </div>
      <hr />
      <h1 className="text-center text-4xl font-bold mt-8">
        Contract Wizard template 🚀
      </h1>
      {/* Connect to Metamask */}
      ...
      <footer className="footer">
        <h1 className="mt-4 text-xs sm:text-sm text-black">
          Learn more about Contract Wizard {""}
          <a
            className="text-blue-500 no-underline hover:underline hover:text-blue-400"
            href="https://www.npmjs.com/package/contract-wizard/"
            target="_blank"
            rel="noopener noreferrer"
          >
            here
